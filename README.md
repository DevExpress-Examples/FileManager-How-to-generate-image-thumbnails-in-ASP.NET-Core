<!-- default badges list -->
![](https://img.shields.io/endpoint?url=https://codecentral.devexpress.com/api/v1/VersionRange/193664916/25.1.3%2B)
...
**Note:** This project has been updated to use **.NET 8.0** and **DevExtreme 25.1.*** with modern ASP.NET Core project structure and minimal hosting approach.
...
```
5. To use the service, create a method in your [API Controller](ASP.NET%20Core/Controllers/FileManagerApiController.cs) that will handle the File Manager operations and inject the service via Dependency Injection in the following way: 
```cs
...
[<img src="https://www.devexpress.com/support/examples/i/yes-button.svg"/>](https://www.devexpress.com/support/examples/survey.xml?utm_source=github&utm_campaign=devextreme-file-manager-image-thumbnails-asp-net-core&~~~was_helpful=yes) [<img src="https://www.devexpress.com/support/examples/i/no-button.svg"/>](https://www.devexpress.com/support/examples/survey.xml?utm_source=github&utm_campaign=devextreme-file-manager-image-thumbnails-asp-net-core&~~~was_helpful=no)
